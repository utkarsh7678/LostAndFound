...
<%
    List<Document> items = (List<Document>) request.getAttribute("lostItems");
    if (items == null || items.isEmpty()) {
%>
    <div class="card mt-3">No lost items reported yet.</div>
<%
    } else {
%>
    <table class="table mt-3">
        <thead>
        <tr><th>Item</th><th>Description</th><th>Location</th><th>Date</th><th>Image</th><th>Matches</th></tr>
        </thead>
        <tbody>
        <%
        ...
        %>
            <tr>
                ...
                <td><%= d.get("matchCount") != null ? d.get("matchCount") : 0 %></td>
            </tr>
        <%
            }
        %>
