...
<div class="container">
    <div class="card" style="max-width:640px; margin: 20px auto;">
        <h2 class="m-0">Report Lost Item</h2>
        <form class="form mt-3" action="${pageContext.request.contextPath}/lost/add" method="post">
            <div>
            ...
            <button class="btn" type="submit">Report Lost Item</button>
        </form>
    </div>
</div>
</body>
